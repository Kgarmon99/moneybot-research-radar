...
<head>
    ...
    <style>
        ...
        .search-bar { width: 100%; padding: 18px 20px; background: #0a0a0a; border: 1px solid var(--border); color: white; font-family: 'Space Grotesk'; font-size: 1.1rem; border-radius: 6px; margin-bottom: 30px; box-sizing: border-box; transition: all 0.3s ease; }
        ...
        .tab { background: none; border: none; color: var(--accent); font-family: 'Space Grotesk'; font-size: 1.1rem; padding: 10px 0; cursor: pointer; border-bottom: 2px solid transparent; transition: all 0.3s; text-transform: uppercase; letter-spacing: 0.05em; font-weight: 600;}
        ...
        /* Cards */
        .card { border: 1px solid var(--border); padding: 24px; margin-bottom: 20px; border-radius: 6px; background-color: #050505; transition: all 0.2s; cursor: pointer;}
        ...
        input[type=range]::-webkit-slider-thumb { -webkit-appearance: none; height: 18px; width: 18px; border-radius: 50%; background: var(--fg); cursor: pointer; margin-top: -7px; box-shadow: 0 0 10px rgba(255,255,255,0.5); transition: transform 0.1s;}
        ...
        .tax-result { font-size: 3rem; font-weight: 700; color: #ff4444; margin: 5px 0; text-shadow: 0 0 20px rgba(255,68,68,0.2); letter-spacing: -0.05em;}
...
<body>
    <div class="container">
        ...
        <p style="color: var(--accent); max-width: 600px; margin-top: -20px; margin-bottom: 40px;">
        ...
        <!-- TABS -->
        <div class="tabs">
            <button class="tab active" onclick="switchTab('dashboard')">Overview Dashboard</button>
            <button class="tab" onclick="switchTab('library')">Research Library</button>
            <button class="tab" onclick="switchTab('feed')">Live NBER Feed</button>
        </div>
        ...
        <div id="dashboard" class="tab-content active">
            <div class="dashboard-grid">
                ...
                <div class="viz-card">
                    ...
                    <div style="font-size: 2.5rem; font-weight: 700; margin-bottom: 20px; letter-spacing: -0.05em;">25 <span style="font-size: 1.2rem; color: var(--accent); font-weight: 400; letter-spacing: normal;">/ 50 States</span></div>
                    ...
                    <p style="font-size: 0.85rem; color: var(--accent); margin-top: 15px; line-height: 1.5;">Interactive view: States currently guaranteeing a standalone Personal Finance course for high school graduation.</p>
                </div>
                ...
                <div class="viz-card">
                    ...
                    <p style="font-size: 0.85rem; color: var(--accent); margin-top: 30px; line-height: 1.5;">Percentage of core financial literacy questions answered correctly. The capability gap is rapidly widening for younger generations.</p>
                </div>
            </div>
            ...
            <div class="viz-card" style="margin-bottom: 40px;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                    <div style="flex: 1; padding-right: 40px;">
                        <label style="font-weight: 600; font-size: 1.1rem;">Average Credit Card Balance: $<span id="debtDisplay">5,000</span></label>
                        <input type="range" id="debtSlider" min="500" max="25000" step="500" value="5000" oninput="calcTax()">
                        <p style="font-size: 0.85rem; color: var(--accent); line-height: 1.5; margin-top: 10px;">
                            Based on Lusardi's research (Stanford SIEPR), individuals with low financial literacy pay roughly a <strong>6% premium</strong> in transaction fees, higher interest rates, and minimum payment traps compared to highly literate peers.
                        </p>
                    </div>
                    <div style="text-align: right; min-width: 200px; padding-left: 20px; border-left: 1px solid var(--border);">
    ...
    <script>
        ...
        function calcTax() {
            ...
            // The "Fragility Tax" logic: 6% premium on average debt (Lusardi et al.)
            const tax = debt * 0.06; 
...
<head>
    ...
    <style>
        ...
        h1, h2, h3 { font-weight: 600; letter-spacing: -0.03em; }
        h1 { font-size: 2.5rem; border-bottom: 1px solid var(--border); padding-bottom: 10px; margin-bottom: 20px; margin-top: 30px;}
