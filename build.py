...
<head>
    ...
    <style>
        ...
        .calc-container { display: flex; justify-content: space-between; align-items: flex-end; }
        .calc-left { flex: 1; padding-right: 40px; }
        .calc-right { text-align: right; min-width: 200px; padding-left: 20px; border-left: 1px solid var(--border); }
        ...
        @media(max-width: 768px) { 
            ...
            .calc-container { display: block !important; }
            .calc-left { padding-right: 0 !important; width: 100% !important; margin-bottom: 20px !important; display: block !important; }
            .calc-right { text-align: left !important; padding-left: 0 !important; border-left: none !important; border-top: 1px solid var(--border) !important; padding-top: 20px !important; width: 100% !important; display: block !important; }
