...
<head>
    ...
    <style>
        ...
        @media(max-width: 768px) { 
            ...
            .tabs::-webkit-scrollbar { display: none; } /* Hide scrollbar for clean look on mobile */
            
            .card { padding: 18px; margin-bottom: 15px; }
            .viz-card { padding: 18px; }
            
            .calc-container { flex-direction: column; align-items: flex-start; }
            .calc-left { padding-right: 0; width: 100%; margin-bottom: 20px; }
            .calc-right { text-align: left; padding-left: 0; border-left: none; border-top: 1px solid var(--border); padding-top: 20px; width: 100%; }
